...
public static class SensorCalibrator
{
    ...
    public static int GetScaledAirQualityValue(float sensorValue)
    {
        ...
        if (value < min)
            ...
            scaledValue = (value - min) / 120; // divide by 120 to get a scale from 1-10
    ...
    public static int GetScaledSoundValue(float sensorValue)
    {
        ...
        if (value < min)
            ...
            scaledValue = (value - min) / 5; // minus 100 to put range as 0-50 for easier calculation... then divide by 100 to get a scale from 1-10
